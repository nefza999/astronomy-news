...
const AN_translations = {
    en: {
        ...
        'An.reaction.shareTelegram': 'Share on Telegram',
        'An.reaction.shareEmail': 'Share via Email',
	...
	'An.profile.title': 'Personal Profile',
	'An.profile.avatar': 'Avatar',
	'An.profile.changeAvatar': 'Change Avatar',
	'An.profile.chooseAvatar': 'Choose Your Avatar',
	'An.profile.uploadAvatar': 'Upload Your Own',
	'An.profile.personalInfo': 'Personal Information',
	'An.profile.fullName': 'Full Name',
	'An.profile.username': 'Username',
	'An.profile.email': 'Email Address',
	'An.profile.bio': 'Bio',
	'An.profile.bioPlaceholder': 'Tell us about your interest in astronomy...',
	'An.profile.location': 'Location',
	'An.profile.locationPlaceholder': 'City, Country',
	'An.profile.changePassword': 'Change Password',
	'An.profile.currentPassword': 'Current Password',
	'An.profile.newPassword': 'New Password',
	'An.profile.confirmPassword': 'Confirm New Password',
	'An.profile.yourActivity': 'Your Activity',
	'An.profile.reactions': 'Reactions Given',
	'An.profile.comments': 'Comments Posted',
	'An.profile.daysActive': 'Days Active',
	'An.profile.memberSince': 'Member Since',
	'An.profile.dangerZone': 'Danger Zone',
	'An.profile.deleteWarning': 'Once you delete your account, there is no going back. Please be certain.',
	'An.profile.deleteAccount': 'Delete Account',
	'An.profile.saveChanges': 'Save Changes',
	'An.profile.cancel': 'Cancel',
	'An.profile.saveAvatar': 'Save Avatar',
	'An.profile.profileUpdated': 'Profile updated successfully!',
	'An.profile.avatarUpdated': 'Avatar updated successfully!',
	'An.profile.passwordChanged': 'Password changed successfully!',
	'An.profile.accountDeleted': 'Account deleted successfully',
	'An.profile.confirmDelete': 'Are you sure you want to delete your account? This action cannot be undone!',
	'An.profile.edit': 'Edit',
	'An.profile.save': 'Save',
	'An.profile.home': 'Home',
	'An.profile.back': 'Back',
	'An.profile.manageProfile': 'Manage Your Profile',
    ...
    fr: {
        ...
        'An.reaction.shareTelegram': 'Partager sur Telegram',
        'An.reaction.shareEmail': 'Partager par email',
...
'An.profile.title': 'Profil Personnel',
'An.profile.avatar': 'Avatar',
'An.profile.changeAvatar': 'Changer l\'Avatar',
'An.profile.chooseAvatar': 'Choisissez Votre Avatar',
'An.profile.uploadAvatar': 'Téléverser le Vôtre',
'An.profile.personalInfo': 'Informations Personnelles',
'An.profile.fullName': 'Nom Complet',
'An.profile.username': 'Nom d\'Utilisateur',
'An.profile.email': 'Adresse E-mail',
'An.profile.bio': 'Biographie',
'An.profile.bioPlaceholder': 'Parlez-nous de votre intérêt pour l\'astronomie...',
'An.profile.location': 'Localisation',
'An.profile.locationPlaceholder': 'Ville, Pays',
'An.profile.changePassword': 'Changer le Mot de Passe',
'An.profile.currentPassword': 'Mot de Passe Actuel',
'An.profile.newPassword': 'Nouveau Mot de Passe',
'An.profile.confirmPassword': 'Confirmer le Nouveau Mot de Passe',
'An.profile.yourActivity': 'Votre Activité',
'An.profile.reactions': 'Réactions Données',
'An.profile.comments': 'Commentaires Postés',
'An.profile.daysActive': 'Jours d\'Activité',
'An.profile.memberSince': 'Membre Depuis',
'An.profile.dangerZone': 'Zone Sensible',
'An.profile.deleteWarning': 'Une fois votre compte supprimé, il n\'y aura pas de retour en arrière. Veuillez en être certain.',
'An.profile.deleteAccount': 'Supprimer le Compte',
'An.profile.saveChanges': 'Enregistrer les Modifications',
'An.profile.cancel': 'Annuler',
'An.profile.saveAvatar': 'Enregistrer l\'Avatar',
'An.profile.profileUpdated': 'Profil mis à jour avec succès !',
'An.profile.avatarUpdated': 'Avatar mis à jour avec succès !',
'An.profile.passwordChanged': 'Mot de passe modifié avec succès !',
'An.profile.accountDeleted': 'Compte supprimé avec succès',
'An.profile.confirmDelete': 'Êtes-vous sûr de vouloir supprimer votre compte ? Cette action est irréversible !',
'An.profile.edit': 'Modifier',
'An.profile.save': 'Enregistrer',
'An.profile.home': 'Accueil',
'An.profile.back': 'Retour',
'An.profile.manageProfile': 'Gérer Votre Profil',
    ...
    ar: {
        ...
        'An.reaction.shareTelegram': 'مشاركة على تيليجرام',
        'An.reaction.shareEmail': 'مشاركة عبر البريد الإلكتروني',
...
'An.profile.title': 'الملف الشخصي',
'An.profile.avatar': 'الصورة الرمزية',
'An.profile.changeAvatar': 'تغيير الصورة الرمزية',
'An.profile.chooseAvatar': 'اختر صورتك الرمزية',
'An.profile.uploadAvatar': 'رفع صورة خاصة',
'An.profile.personalInfo': 'المعلومات الشخصية',
'An.profile.fullName': 'الاسم الكامل',
'An.profile.username': 'اسم المستخدم',
'An.profile.email': 'البريد الإلكتروني',
'An.profile.bio': 'السيرة الذاتية',
'An.profile.bioPlaceholder': 'أخبرنا عن اهتمامك بعلم الفلك...',
'An.profile.location': 'الموقع',
'An.profile.locationPlaceholder': 'المدينة، الدولة',
'An.profile.changePassword': 'تغيير كلمة المرور',
'An.profile.currentPassword': 'كلمة المرور الحالية',
'An.profile.newPassword': 'كلمة المرور الجديدة',
'An.profile.confirmPassword': 'تأكيد كلمة المرور الجديدة',
'An.profile.yourActivity': 'نشاطك',
'An.profile.reactions': 'ردود الفعل المعطاة',
'An.profile.comments': 'التعليقات المنشورة',
'An.profile.daysActive': 'أيام النشاط',
'An.profile.memberSince': 'عضو منذ',
'An.profile.dangerZone': 'منطقة الخطر',
'An.profile.deleteWarning': 'بمجرد حذف حسابك، لا يمكنك الرجوع. يرجى التأكد.',
'An.profile.deleteAccount': 'حذف الحساب',
'An.profile.saveChanges': 'حفظ التغييرات',
'An.profile.cancel': 'إلغاء',
'An.profile.saveAvatar': 'حفظ الصورة الرمزية',
'An.profile.profileUpdated': 'تم تحديث الملف الشخصي بنجاح!',
'An.profile.avatarUpdated': 'تم تحديث الصورة الرمزية بنجاح!',
'An.profile.passwordChanged': 'تم تغيير كلمة المرور بنجاح!',
'An.profile.accountDeleted': 'تم حذف الحساب بنجاح',
'An.profile.confirmDelete': 'هل أنت متأكد من رغبتك في حذف حسابك؟ لا يمكن التراجع عن هذا الإجراء!',
'An.profile.edit': 'تعديل',
'An.profile.save': 'حفظ',
'An.profile.home': 'الرئيسية',
'An.profile.back': 'رجوع',
'An.profile.manageProfile': 'إدارة ملفك الشخصي',
...
function AN_applyTranslations(language) {
    ...
    document.querySelectorAll('.AN-share-option span').forEach(element => {
        ...
        if (platform === 'facebook') {
			...
			element.textContent = lang['An.reaction.shareTelegram'];
